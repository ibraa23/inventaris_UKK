...
class PengadaanController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('user.pengadaan.create', compact('masterBarang', 'depresiasi', 'merk', 'satuan', 'subKategoriAsset', 'distributor'));
    }
    ...
    public function edit(Pengadaan $pengadaan)
    {
        ...
        $subKategoriAsset = SubKategoriAsset::all();
        $distributor = Distributor::all();
        return view('user.pengadaan.edit', compact('pengadaan', 'masterBarang', 'depresiasi', 'merk', 'satuan', 'subKategoriAsset', 'distributor'));
    }
